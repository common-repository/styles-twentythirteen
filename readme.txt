...
This plugin adds suport for the TwentyThirteen theme to the [Styles plugin](http://wordpress.org/extend/plugins/styles).
...
1. Upload the `styles-twentythirteen folder to the `/wp-content/plugins/` directory
